...
bool neon_enabled_at_compile_time(){return true;}

#else

int64_t sum_array_neon(const std::vector<int32_t>& v){return sum_array_basic(v);}

bool neon_enabled_at_compile_time() {return false;}
